...
function AddInput({ options, add, addlist, restTime, onArchivedUpdate }) {
    ...
    return <div className="flex flex-row justify-center items-center mt-16" >
        ...
        <div className={`${restTime ? 'bg-green-600' : 'bg-red-600'} w-auto h-2/6 px-2 rounded-full justify-start items-center flex flex-row`}>
