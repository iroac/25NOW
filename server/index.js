...
const sessionConfig = { secret: 'wjdijfaWISomecrazyvaribleherefjaifaw', store: MongoStore.create({ mongoUrl: process.env.MONGODB_URL, mongooseConnection: mongoose.connection }), resave: false, saveUninitialized: true, cookie: { secure: true, sameSite: 'none', HttpOnly: true, domain: '25-now-iroac.vercel.app' }, maxAge: 24 * 60 * 60 * 1000 }
